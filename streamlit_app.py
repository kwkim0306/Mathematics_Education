                ...
                try:
                    ...
                    if extremum_xs:
                        ...
                        if show_axis_x:
                            ...
                            for x0 in extremum_xs:
                                ax.text(float(x0), -0.1, format_value(x0), color="red", fontsize=6, ha="center", va="top", fontproperties=font_prop)
                        if show_axis_y:
                            ax.scatter(np.full_like(y_ext, -0.1), y_ext, color="red", s=2, zorder=4, alpha=0.8)
                            for y0 in y_ext:
                                ax.text(-0.1, y0, format_value(y0), color="red", fontsize=6, ha="right", va="center", fontproperties=font_prop)
                    if inflection_xs:
                        y_inf = []
                        ...
                        if show_axis_x:
                            ...
                            for x0 in inflection_xs:
                                ax.text(float(x0), -0.1, format_value(x0), color="green", fontsize=6, ha="center", va="top", fontproperties=font_prop)
                        if show_axis_y:
                            ax.scatter(np.full_like(y_inf, -0.1), y_inf, color="green", s=2, zorder=4, alpha=0.8)
                            for y0 in y_inf:
                                ax.text(-0.1, y0, format_value(y0), color="green", fontsize=6, ha="right", va="center", fontproperties=font_prop)
